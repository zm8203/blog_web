<template>
  <a-modal title="全文搜索" width="40%" v-model:visible="visible" :footer="false" body-class="gvb_search_body">
    <div class="head">
...
import type {articleSearchType} from "@/api/article_api";
import {articleSearchApi} from "@/api/article_api";
