<template>
  <gvb_config
      ...
      :left-width="40"
      :right-with="60"
      :label-span="isLaptops1?4:3"
      :wrapper-span="isLaptops1? 20:21"
      :column="column" :help-data="helpList">
    <template #alert>
      <a-alert style="margin-top: 20px">高德key，获取用户所在城市的天气数据</a-alert>
    </template>
  </gvb_config>
</template>
...
import type {gaodeType} from "@/api/settings_api";

const isLaptops1 = isLaptops

const column: configColumnType<gaodeType>[] = [
  {
    label: "启用",
    field: "enable",
    type: "boolean"
